...
from movies.adapters.orm import metadata
...
def test_database_populate_select_all_comments(database_engine):
    ...
    with database_engine.connect() as connection:
        ...
        all_comments = []
        for row in result:
            all_comments.append((row['id']))

        assert all_comments == [1,
 2,
 3,
 4,
 5,
...
def test_database_populate_select_all_movies(database_engine):
    ...
    with database_engine.connect() as connection:
        ...
        assert all_movies[nr_movies//2] == (89)
        assert all_movies[nr_movies-1] == (177)
